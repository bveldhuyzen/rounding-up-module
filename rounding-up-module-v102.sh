...
#2. The decimals to which [1] has to be rounded up to are obtained; the module will round up to the nearest (multiple of) specified decimal(s) // see line 25
...
#5. The numerical value to round up to at [2] is multiplied by the multiplication factor of [3], resulting in a new number being rounded up to the nearest (multiple of) [2]
